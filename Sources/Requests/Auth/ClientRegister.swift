...
extension API.Auth {
    ...
    public enum ClientRegister {

        public static let service = APIService<Response>(id: "clientRegister", tag: "Auth", method: "POST", path: "/api/v1/client/register", hasBody: true)

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ClientRegister.service)
            }
        }
